...
/*   Updated: 2023/03/21 19:50:42 by hahlee           ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
void	init_table(t_table *table)
{
	...
	sem_unlink("eat");
	sem_unlink("print");
	table->forks = sem_open("fork", O_CREAT | O_EXCL, \
	0644, table->argv[NUM_PHILO]);
	table->eat_enough = sem_open("eat", O_CREAT | O_EXCL, 0644, \
	table->argv[NUM_PHILO]);
